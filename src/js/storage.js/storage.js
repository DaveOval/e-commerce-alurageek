//Clase del prodcuto
import { Product } from '../usecases/constructor';

const LSkeyboards = localStorage.getItem('keyboard');
const LSkeycaps   = localStorage.getItem('keycaps');
const LSswitchs   = localStorage.getItem('switchs');
...
export const state = {
  ...
  keycaps:[
    ...
    new Product('UNIVERSE VITALITY', 69.00, 'https://cdn.shopify.com/s/files/1/0440/6676/7015/products/keygeak-Universe-series-keycap-set_3bc6fff8-03b3-4535-a5e0-49090058e8d5.jpg?v=1650246778', 6 , 'keycaps'),
  ...
  const addToStateKeyboard = () =>{
    if(LSkeyboards === null){
      console.log('no keyboards in LS');
    }else{
  ...
  const addToStateKeycaps = () =>{
    if(LSkeycaps === null){
      console.log('no keycaps in LS');
    }else{
  ...
  const addToSateSwitchs = () =>{
    if(LSswitchs === null){
      console.log('no switchs in LS');
    }else{
